...
export default function Sidebar() {
  return (
    <aside aria-label="App Navigation" className="w-20 bg-gray-900 text-gray-400 flex flex-col items-center py-4 h-screen flex-shrink-0">
      <div className="w-10 h-10 bg-primary-500 rounded-xl flex items-center justify-center text-white font-bold text-sm mb-6 shadow-lg shadow-primary-500/20" aria-hidden="true">
        B
      </div>
      ...
      <div className="flex flex-col gap-3 items-center mt-auto">
        ...
        <div className="w-8 h-8 rounded-full bg-primary-100 text-primary-600 font-bold text-xs flex items-center justify-center" aria-label="User profile: E M">
          EM
        </div>
      </div>
    </aside>
